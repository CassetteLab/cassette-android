...
internal sealed interface ServerConfigurationEvent : Event {
    ...
    data class OnRemoveHeaderClicked(
        val id: Long,
    ) : ServerConfigurationEvent

    data class OnHeaderNameChanged(
        val id: Long,
        val value: String,
    ) : ServerConfigurationEvent

    data class OnHeaderValueChanged(
        val id: Long,
        val value: String,
    ) : ServerConfigurationEvent,
        SensitiveEvent

    data class OnHeaderValueVisibilityChanged(
        val id: Long,
