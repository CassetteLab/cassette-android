...
import fr.cassettelabs.cassette.presentation.core.mvi.SensitiveEvent
...
internal sealed interface ServerConfigurationEvent : Event {
    ...
    data class OnPasswordChanged(val value: String) : ServerConfigurationEvent, SensitiveEvent
    ...
    data class OnHeaderValueChanged(val id: Long, val value: String) : ServerConfigurationEvent, SensitiveEvent
