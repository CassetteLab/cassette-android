...
import fr.cassettelabs.cassette.data.remote.player.DesktopMediaSessionController
...
actual val dataPlatformModule: Module
    get() = module {
        ...
        singleOf(::DesktopMediaSessionController) bind PlatformMediaSessionController::class
    }
